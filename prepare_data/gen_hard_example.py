...
from prepare_data.data_utils import get_path, read_annotation
...
def parse_args():
    ...
    parser.add_argument('--test_mode',
                        dest='test_mode',
                        help='test net type, can be pnet, rnet or onet',
                        default='RNet',
                        type=str)
    parser.add_argument(
        '--prefix',
        ...
        default=[
            ...
            # '../data/MTCNN_model/RNet_No_Landmark/RNet',
...
if __name__ == '__main__':
    ...
    print(args)
    t_net(
        args.prefix,  # model param's file

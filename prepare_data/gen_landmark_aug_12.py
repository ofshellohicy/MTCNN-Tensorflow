...
if __name__ == '__main__':
    dstdir = "%s/../DATA/12/train_PNet_landmark_aug" % init_path.ROOT_DIR
    OUTPUT = '%s/../DATA/12' % init_path.ROOT_DIR
    data_path = '%s/../DATA' % init_path.ROOT_DIR
    ...
    train_txt = "%s/prepare_data/trainImageList.txt" % init_path.ROOT_DIR
